				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.jiuyerenshu" type="text" :readonly="ro.jiuyerenshu" name="jiuyerenshu" id="jiuyerenshu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">统计时间：</label>
						<div class="layui-input-block">
							<input type="text" name="tongjishijian" id="tongjishijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
						  ...
						  carousel.render({
							...
							width: '100%',
						  	...
						  	indicator: 'none'
                                ...
                                jquery('#tongjishijian').val(getCurDate());
				laydate.render({
					elem: '#tongjishijian'
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='jiuyerenshu'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jiuyerenshu = true;
                                                continue;
                                        }
                                        if(o=='tongjishijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.tongjishijian = true;
                                                jquery('#tongjishijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='jiaoshigonghao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('jiuyetongji/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('jiuyetongji' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
