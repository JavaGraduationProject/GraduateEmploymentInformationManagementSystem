			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">就职单位：</label>
						<div class="layui-input-block">
							<input v-model="detail.jiuzhidanwei" type="text" :readonly="ro.jiuzhidanwei" name="jiuzhidanwei" id="jiuzhidanwei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		                <label class="layui-form-label">单位性质</label>
		                <div class="layui-input-block">
		                    <select name="danweixingzhi" id="danweixingzhi" lay-filter="danweixingzhi"  >
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="jiuyeshijian" id="jiuyeshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.jiaoshigonghao" type="text" :readonly="ro.jiaoshigonghao" name="jiaoshigonghao" id="jiaoshigonghao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
				...
				data: {
					...
					danweixingzhi: '外资,中外合资,国有企业,私人企业'.split(','),
					gangweifenlei: [],
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                form.on('select(danweixingzhi)', function (data) {
                    vue.detail.danweixingzhi=data.value;
                });
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='jiuzhidanwei'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jiuzhidanwei = true;
                                                continue;
                                        }
                                        if(o=='danweixingzhi'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.danweixingzhi = true;
                                                continue;
                                        }
                                        if(o=='gangweifenlei'){
                                                vue.detail[o] = obj[o];
                                        ...
                                        if(o=='jiuyeshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.jiuyeshijian = true;
                                                jquery('#jiuyeshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='xuehao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('jiuyexinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('jiuyexinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
