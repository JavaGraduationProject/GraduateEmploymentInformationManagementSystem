...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑学生应聘</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑学生应聘</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生应聘信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>岗位分类</label>
										<input name="gangweifenlei" id="gangweifenlei" name="gangweifenlei" class="form-control" placeholder="岗位分类">
									</div>
									<div class="form-group col-md-6">
										<label>岗位薪酬</label>
									...
									<div class="form-group col-md-6">
										<label>个人简历</label>
										<div>
										<div class="upload">选择文件<input name="file" type="file" class="form-control-file" id="gerenjianliupload"></div>
										<label id="gerenjianliFileName"></label>
										<input name="gerenjianli" id="gerenjianli-input" type="hidden">
										</div>
									</div>
									<div class="form-group col-md-6">
										<label>申请日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xueshengyingpin/info/" + id,
		...
		function upload(){
			...
			$('#gerenjianliupload').fileupload({
				url: baseUrl + 'file/upload',
				headers:{ token: window.sessionStorage.getItem("token")},
				dataType: 'json',
				done: function (e, data) {							
					document.getElementById('gerenjianli-input').setAttribute('value','file/download?fileName='+data.result.file);
					if(document.getElementById('gerenjianliFileName') != null){
						document.getElementById('gerenjianliFileName').innerHTML = "上传成功!";
					}		
					$("#gerenjianliImg").attr("src",data.result.file);												
				}
			});
		}  
		//取消 
				...
				if(crossrefid && crossuserid) {
					...
					http("xueshengyingpin/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("xueshengyingpin/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.zhuanye != null && res.data.zhuanye != ''){
		...
		function dataBind(){
			...
			$("#gangweifenlei").val(ruleForm.gangweifenlei);	
			$("#gangweixinchou").val(ruleForm.gangweixinchou);	
			$("#gongzuodidian").val(ruleForm.gongzuodidian);	
			$("#zhaopinqiye").val(ruleForm.zhaopinqiye);	
			$("#gerenjianli-input").val(ruleForm.gerenjianli);
			$("#gerenjianliFileName").html(ruleForm.gerenjianli);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gangweifenlei != null && res.data.gangweifenlei != ''){
						...
						$("#gangweifenlei").val(res.data.gangweifenlei);
						$("#gangweifenlei").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.gerenjianli != null && res.data.gerenjianli != ''){

						$("#gerenjianli-input").val(res.data.gerenjianli);
						$('#gerenjianliFileName').val(res.data.gerenjianli)
					}
