...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210730/85b62479180e415787e4deea71daa29f.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	#login-wrapper {
		...
		box-shadow: 6px 2px 9px rgba(11, 11, 11,1);
	}
	...
	#registerForm button.pull-right {
		...
		border-style: solid;
		border-color: #ccc;
		background-color: rgba(161, 204, 215, 1);
		box-shadow: 0 0 6px rgba(30, 144, 255, 0);
	}
