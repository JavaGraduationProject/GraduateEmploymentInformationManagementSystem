...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>教师工号</label>
										<select id="jiaoshigonghaoSelect" name="jiaoshigonghao" class="form-control">
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>联系方式</label>
	...
	<script>
		...
		var jiaoshigonghaoOptions = [];

		function jiaoshigonghaoSelect(){
			http("option/jiaoshi/jiaoshigonghao","GET",{},(res)=>{
				if(res.code == 0){
					jiaoshigonghaoOptions = res.data;
					var nullOption = document.createElement('option');
					var jiaoshigonghaoSelect = document.getElementById('jiaoshigonghaoSelect');
					jiaoshigonghaoSelect.appendChild(nullOption);
					for(var i=0;i<jiaoshigonghaoOptions.length;i++){
						var jiaoshigonghaoOption = document.createElement('option');
						jiaoshigonghaoOption.setAttribute('name','jiaoshigonghaoOption');
						jiaoshigonghaoOption.setAttribute('value',jiaoshigonghaoOptions[i]);
						jiaoshigonghaoOption.innerHTML = jiaoshigonghaoOptions[i];									
						if(ruleForm.jiaoshigonghao == jiaoshigonghaoOptions[i]){
							jiaoshigonghaoOption.setAttribute('selected','selected');
						}
						jiaoshigonghaoSelect.appendChild(jiaoshigonghaoOption);
					}
				}
			});
		}	
		...
		function submit() {
                //获取表单数据前取消禁用
                $("#jiaoshigonghaoSelect").attr('disabled',false);
		...
		function dataBind(){
			...
			var jiaoshigonghaoOptions = document.getElementsByClassName("jiaoshigonghaoOption");
			for(var jiaoshigonghaoCount = 0; jiaoshigonghaoCount < jiaoshigonghaoOptions.length;jiaoshigonghaoCount++){
				if(jiaoshigonghaoOptions[jiaoshigonghaoCount].getAttribute('value') == ruleForm.jiaoshigonghao){
					jiaoshigonghaoOptions[jiaoshigonghaoCount].setAttribute('selected','selected');
				}
			}
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiaoshigonghao != null && res.data.jiaoshigonghao != ''){
						...
						var jiaoshigonghaoOptions = document.getElementsByClassName("jiaoshigonghaoOption");
						for(var jiaoshigonghaoCount = 0; jiaoshigonghaoCount < jiaoshigonghaoOptions.length;jiaoshigonghaoCount++){
							if(jiaoshigonghaoOptions[jiaoshigonghaoCount].getAttribute('value') == res.data.jiaoshigonghao){
								jiaoshigonghaoOptions[jiaoshigonghaoCount].setAttribute('selected','selected');
							}
						}
					}
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#jiaoshigonghaoSelect").attr('disabled',true);
            }
		}
