					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑就业信息</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>就职单位</label>
										<input name="jiuzhidanwei" id="jiuzhidanwei" name="jiuzhidanwei" class="form-control" placeholder="就职单位">
									</div>
									<div class="form-group col-md-6">
										<label>单位性质</label>
										<select id="danweixingzhiSelect" name="danweixingzhi" class="form-control">
												<option value=""></option>
												<option class="danweixingzhiOption" value="外资">
													外资
												</option>
												<option class="danweixingzhiOption" value="中外合资">
													中外合资
												</option>
												<option class="danweixingzhiOption" value="国有企业">
													国有企业
												</option>
												<option class="danweixingzhiOption" value="私人企业">
													私人企业
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>就业时间</label>
										<div id="jiuyeshijianDate" class="input-append date form_datetime">
											<input id="jiuyeshijian-input" name="jiuyeshijian" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jiuyexinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jiuyexinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jiuyexinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jiuyexinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#jiuyeshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#jiuzhidanwei").val(ruleForm.jiuzhidanwei);	
			var danweixingzhiOptions = document.getElementsByClassName("danweixingzhiOption");
			for(var danweixingzhiCount = 0; danweixingzhiCount < danweixingzhiOptions.length;danweixingzhiCount++){
				if(danweixingzhiOptions[danweixingzhiCount].getAttribute('value') == ruleForm.danweixingzhi){
					danweixingzhiOptions[danweixingzhiCount].setAttribute('selected','selected');
				}
			}
			...
			$("#jiuyeshijian-input").val(ruleForm.jiuyeshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiuzhidanwei != null && res.data.jiuzhidanwei != ''){

						$("#jiuzhidanwei").val(res.data.jiuzhidanwei);
						$("#jiuzhidanwei").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.danweixingzhi != null && res.data.danweixingzhi != ''){

						var danweixingzhiOptions = document.getElementsByClassName("danweixingzhiOption");
						for(var danweixingzhiCount = 0; danweixingzhiCount < danweixingzhiOptions.length;danweixingzhiCount++){
							if(danweixingzhiOptions[danweixingzhiCount].getAttribute('value') == res.data.danweixingzhi){
								danweixingzhiOptions[danweixingzhiCount].setAttribute('selected','selected');
							}
						}
					}
					...
					if(res.data != null && res.data != '' && res.data.jiuyeshijian != null && res.data.jiuyeshijian != ''){

						$("#jiuyeshijian-input").val(res.data.jiuyeshijian);
						$('#jiuyeshijianFileName').val(res.data.jiuyeshijian)
					}
